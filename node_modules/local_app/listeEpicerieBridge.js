    ...
    , addRemove: (context) =>
      {
        ...
        message.callbackButtons = ListeEpicerieBridge.markups.addRemoveButtons;

        context.editMessageReplyMarkup(Markup.inlineKeyboard(message.callbackButtons).resize());
      }
    , addRemoveCategories: (context) =>
      {
        var message = context.session.message;

        message.callbackButtons = ListeEpicerieBridge.markups.addRemoveCategoriesButtons;
  ...
  , markups:
    {
      listCallbackButtons:
      [
        [ Markup.callbackButton("Ajouter/retirer des éléments", "/addRemove_callback") ]
        , [ Markup.callbackButton("Ajouter/retirer des catégories", "/addRemoveCategories_callback") ]
      ...
      , addRemoveButtons:
        [
          ...
          , [ Markup.callbackButton("Retour", "/cancel_callback") ]
        ]
      , addRemoveCategoriesButtons:
        [
      ...
      , categorizeCallbackButtons:
        [
          [ Markup.callbackButton("Sélectionner une catégorie", "/categorizeDisplayCategories_callback") ]
          , [ Markup.callbackButton("Annuler", "/cancel_callback") ]
        ]
